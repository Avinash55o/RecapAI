#!/bin/bash
echo "=== RecapAI - Invisible Edition ==="
echo
...
mkdir -p ~/Library/Application\ Support/recap-ai/temp
mkdir -p ~/Library/Application\ Support/recap-ai/cache
mkdir -p ~/Library/Application\ Support/recap-ai/screenshots
mkdir -p ~/Library/Application\ Support/recap-ai/extra_screenshots
