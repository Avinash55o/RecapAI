...
mkdir "%APPDATA%\recap-ai\temp" 2>nul
mkdir "%APPDATA%\recap-ai\cache" 2>nul
mkdir "%APPDATA%\recap-ai\screenshots" 2>nul
mkdir "%APPDATA%\recap-ai\extra_screenshots" 2>nul
